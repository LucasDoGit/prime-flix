...
![Foto de Capa](public/capa-projeto.png)

## Sumário

- [\[Prime Flix\]](#prime-flix)
  - [Sumário](#sumário)
...
Uma plataforma que busca os 10 filmes em cartas mais recentes, usando API da [themoviedb](https://www.themoviedb.org). É possível visualizar informações dos filmes, trailer e adicionar aos favoritos. O objetivo desta aplicação é explorar e aprender a biblioteca React.js.
...
```bash
git clone https://github.com/LucasDoGit/prime-flix
cd prime-flix
```
